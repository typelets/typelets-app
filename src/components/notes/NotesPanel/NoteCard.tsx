...
function NoteCard({
  ...
  const FileTypeIcon = () => {
    ...
    switch (note.type) {
      case 'diagram':
        return <Icon path={mdiVectorSquare} style={{ width: "18px", height: "18px" }} className="text-purple-500" />;
      case 'code':
        return <SquareCode className="h-[19px] w-[19px] text-gray-800 dark:text-gray-300" />;
      case 'sheets':
  ...
  return (
    <div
      className={`group border-border relative cursor-default border-b transition-colors last:border-b-0 ${
    ...
    >
      ...
      <div className="flex p-2.5 pl-3.5">
