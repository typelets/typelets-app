...
export type LightThemePreset = 'default' | 'warmWhite' | 'coolGray' | 'lavender' | 'mint' | 'rose' | 'peach' | 'sky';
export type DarkThemePreset = 'trueBlack' | 'defaultDark' | 'deepBlue' | 'darkPurple' | 'forest' | 'darkRed' | 'darkOrange' | 'darkTeal';
...
export const DARK_THEME_PRESETS: Record<DarkThemePreset, ThemePreset> = {
  ...
  darkRed: {
    id: 'darkRed',
    name: 'Dark Red',
    description: 'Deep crimson accents',
    colors: {
      background: '#1a0a0a',
      foreground: '#ffe8e8',
      card: '#2a1414',
      cardForeground: '#ffe8e8',
      primary: '#f87171',
      primaryForeground: '#1a0a0a',
      secondary: '#3a1e1e',
      secondaryForeground: '#ffe8e8',
      muted: '#3a1e1e',
      mutedForeground: '#fca5a5',
      accent: '#3a1e1e',
      accentForeground: '#ffe8e8',
      destructive: '#ef4444',
      destructiveForeground: '#ffffff',
  ...
  darkOrange: {
    ...
    colors: {
      ...
      foreground: '#fff5e8',
      card: '#2a1f14',
      cardForeground: '#fff5e8',
      primary: '#fb923c',
      primaryForeground: '#1a0f05',
      secondary: '#3a2f1e',
      secondaryForeground: '#fff5e8',
      muted: '#3a2f1e',
      mutedForeground: '#fdba74',
      accent: '#3a2f1e',
      accentForeground: '#fff5e8',
      destructive: '#f87171',
      destructiveForeground: '#ffffff',
